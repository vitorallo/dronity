...
CFLAGS += -Wall -W -g -O0 -I. -Iinclude/ -Wimplicit -D_FORTIFY_SOURCE=2 -D_GNU_SOURCE -D__linux__
ifneq ($(SYSROOT),)
...
#original makefile requires version from the script
#dronity: version test $(OBJS) $(HEADERS)
dronity: $(OBJS) $(HEADERS)
