...
int main(int argc, char* argv[])
{
	...
	outputstd("Dronity " VERSION "  Vito Rallo <vito.rallo@gmail.com>\n");
	outputstd("based on Trinity v1.4-752-g23fd7d5 Dave Jones <davej@redhat.com>\n");
	 ...
	 * vito: can't do this before parse_args as I need to understand what to do
	 * with victim_dev
	 */
