...
#ifdef USE_BACKTRACE
/* for future #include <utils/CallStack.h> */
#endif
#include <stdio.h>
#include <stdarg.h>
#include "child.h"
...
{
#ifdef USE_BACKTRACE
	/* backtrace from excecinfo not available in Android, BACKTRACK cannot work,
	 * for the future we can look into
	 * CallStack stack;
	 * stack.update();
	 * stack.dump("");
	 * from #include <utils/CallStack.h> (need to ld with libutils)
	 */
#endif
}
